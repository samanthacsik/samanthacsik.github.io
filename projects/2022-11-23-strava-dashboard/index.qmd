...
[{{< fa brands r-project >}} Shiny dashboard](https://samanthacsik.shinyapps.io/strava_dashboard/){.btn} [{{< fa brands github >}} Source code](https://github.com/samanthacsik/strava-dashboard){.btn}
