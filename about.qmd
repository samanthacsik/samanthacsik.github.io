...
<!--html_preserve-->
<center><iframe src = "images/leaflet_2023-07-17.html", width ="800", height="450"> </iframe></center>
<!--/html_preserve-->
<span style = 'font-size: 90%;'><em><center>Map last updated: July 17, 2023</em></center></span>

<center><p class="larger-text quote-text-bg">{{< fa arrow-pointer >}} For a more interactive experience, click around my [Strava dashboard](https://samanthacsik.shinyapps.io/strava_dashboard/) <br> {{< fa brands github >}} Source code available on [GitHub](https://github.com/samanthacsik/strava-dashboard)</p></center>
