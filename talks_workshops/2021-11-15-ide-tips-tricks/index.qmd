...
<div class="container">
<div class="center">
<button type="button" class="button-styling" onclick=window.location.href='https://ucsb-meds.github.io/IDE-tips-and-tricks/#/title-slide'>{{< fa tv title="A tv screen" >}} slides</button>
<button type="button" class="button-styling" onclick=window.location.href='https://github.com/UCSB-MEDS/IDE-tips-and-tricks'>{{< fa code title="A symbol for code, </>" >}} source code</button> 
</div>
</div>
