...
::: {.center-text}
[{{< fa tv title="A television screen" >}} slides](https://ucsb-meds.github.io/IDE-tips-and-tricks/#/title-slide){.btn role="button"} [{{< fa brands github title="Octocat, the GitHub logo" >}} source code](https://github.com/UCSB-MEDS/IDE-tips-and-tricks){.btn role="button"}
:::
