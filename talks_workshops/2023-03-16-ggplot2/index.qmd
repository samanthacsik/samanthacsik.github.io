...
#| fig-cap: "Art by [Allison Horst](https://allisonhorst.com/): A fuzzy monster in a beret and scarf, critiquing their own column graph on a canvas in front of them while other assistant monsters (also in berets) carry over boxes full of elements that can be used to customize a graph (like themes and geometric shapes). In the background is a wall with framed data visualizations. Stylized text reads 'ggplot2: build a data masterpiece.'"
knitr::include_graphics("ahorst_ggplot2.png")
```

<div class="container">
<div class="center">
<button type="button" class="button-styling" onclick=window.location.href='https://ucsb-meds.github.io/ggplot2-workflow/'>{{< fa file-alt title="A file with lines of text" >}} instructional documentation</button>
<button type="button" class="button-styling" onclick=window.location.href='https://github.com/UCSB-MEDS/ggplot2-workflow/tree/main'>{{< fa code title="A symbol for code, </>" >}} source code</button> 
</div>
</div>

<!-- `r fontawesome::fa("file-alt", fill = "#64605f", a11y = "sem")` -->
<!-- `r fontawesome::fa("github-square", fill = "#64605f", a11y = "sem")` -->
