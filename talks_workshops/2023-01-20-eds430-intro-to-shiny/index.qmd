...
<div class="container">
<div class="center">
<button type="button" class="button-styling" onclick=window.location.href='https://ucsb-meds.github.io/EDS430-Shiny/#/title-slide'>`r fontawesome::fa("tv", fill = "#64605f", a11y = "sem")` slides</button>
<button type="button" class="button-styling" onclick=window.location.href='https://github.com/UCSB-MEDS/EDS430-Shiny'>`r fontawesome::fa("github-square", fill = "#64605f", a11y = "sem")` source code</button> 
</div>
</div>
