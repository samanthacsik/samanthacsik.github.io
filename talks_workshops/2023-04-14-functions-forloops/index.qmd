...
::: {.center-text}
[{{< fa file-alt title="A file with lines of text" >}} materials](https://ucsb-meds.github.io/functions-workshop/){.btn .btn-secondary role="button"} [{{< fa brands github title="Octocat, the GitHub logo" >}} source code](https://github.com/UCSB-MEDS/functions-workshop){.btn .btn-secondary role="button"} 
:::
