...
::: {.center-text}
[{{< fa tv title="A television screen" >}} slides](https://ucsb-meds.github.io/customizing-quarto-websites/#/title-slide){.btn .btn-secondary role="button"} [{{< fa brands github title="Octocat, the GitHub logo" >}} source code](https://github.com/UCSB-MEDS/customizing-quarto-websites){.btn .btn-secondary role="button"}
:::
