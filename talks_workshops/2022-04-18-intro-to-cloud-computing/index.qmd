...
<div class="container">
<div class="center">
<button type="button" class="button-styling" onclick=window.location.href='https://ucsb-meds.github.io/cloud-computing/#1'>{{< fa tv title="A television screen" >}} slides</button>
<button type="button" class="button-styling" onclick=window.location.href='https://github.com/UCSB-MEDS/cloud-computing'>{{< fa code title="A symbol for code, </>" >}} source code</button> 
</div>
</div>
