...
<div class="container">
<div class="center">
<button type="button" class="button-styling" onclick=window.location.href='https://ucsb-meds.github.io/shiny-workshop/#1'>`r fontawesome::fa("tv", fill = "#64605f", a11y = "sem")` slides</button>
<button type="button" class="button-styling" onclick=window.location.href='https://github.com/UCSB-MEDS/shiny-workshop'>`r fontawesome::fa("github-square", fill = "#64605f", a11y = "sem")` source code</button> 
</div>
</div>
