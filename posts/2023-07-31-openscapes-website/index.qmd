...
So why the need to port the Openscapes website to Quarto? Julie originally built the site back (you can still check out the [GitHub repo](https://github.com/Openscapes/website) in 2018 using [blogdown](https://bookdown.org/yihui/blogdown/) and the [Universal Theme for Hugo](https://github.com/Openscapes/website/tree/main/themes/hugo-universal-theme) -- and it was really beautiful! 
...
:::{.quote-text-bg .large-text .center-text}
You can check out the Openscapes website at <https://openscapes.org/>. Source code is available on [{{< fa brands github >}} GitHub](https://github.com/Openscapes/website-new).
:::
