...
We want websites to look good no matter what viewport or device that they're viewed on -- page elements should be resized and reorganized so that they fit neatly within a computer's web browser or on a mobile device screen. For example, see how the landing page appears/changes as the viewport size is adjusted on a laptop: 
...
versus how the landing page appears on a mobile device: 
...
- responsive landing page (done using CSS grid, which is native to Quarto)
