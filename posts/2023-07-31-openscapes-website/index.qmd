...
citation: 
  url: https://samanthacsik.github.io/posts/2023-07-31-openscapes-website/
categories: [Quarto, Openscapes]
image: openscapes_hex.png
draft: true
---

Y'all, I did something really exciting -- I built another website! This time as a first-time freelancer. I'm not sure that I would have had the confidence to accept just any ole' request to do so, but when [Julie Lowndes](https://jules32.github.io/), founding director of Openscapes, and also a mentor turned friend (thank you [R-Ladies Santa Barbara](https://www.meetup.com/rladies-santa-barbara/) community!), asked if I'd be interested in rebuilding the Openscapes website, it felt like a really awesome personal and professional growth opportunity. 

There's so many amazing things I could say about this process and experience, but I'd be writing a novel. Instead, I'm going to do some high-level reflection and focus a bit on the parts of the process that I enjoyed the most. 
...
So why the need to port the Openscapes website to Quarto? Julie originally built the site back in 2018 using [blogdown](https://bookdown.org/yihui/blogdown/) and the [Universal Theme for Hugo](https://github.com/Openscapes/website/tree/main/themes/hugo-universal-theme) -- and it was really beautiful! 
...
knitr::include_graphics("old_site.png")
```
...
Unfortunately, because of changes to Hugo [CHECK WITH JULIE/STEF ABOUT THIS], the site could no longer build locally (i.e. you couldn't preview the site on a personal computer). This meant that the site needed to be redeployed in order to view any changes. Not only was this a rather slow process, but it also meant that there was no easy way to test out new additions/pages/features (or even check for typos) before sharing those updates with the rest of the online world. 
...
*However*, all websites I've built/contributed to/taught about were personal websites (e.g. like my own website, <https://samanthacsik.github.io>) -- oftentimes, these leverage a [special template](https://quarto.org/docs/websites/website-about.html#templates) to easily arrange the contents of a website's landing page. Rebuilding the Openscapes website meant diving deeper into custom layouts, responsive webpages, and generally, a whole lot of stuff I had little to no familiarity with...which honestly really scared me (aren't freelancers supposed to know how to do what they're being hired to do??). With Julie's reassurances that not knowing was okay, and that there was time and space to learn together (*very* on brand for the community she and her team foster through Openscapes {{< fa face-smile >}}), I set off on my first freelancing adventure.
...
2. **Incorporate events:** Openscapes Events were historically announced through a separate [Events blog](https://openscapes.github.io/events/), which we decided to incorporate fully into the Openscapes website on it's own [events listing](https://openscapes.org/events).
...
5. **Figure out responsive web pages:** I saved the most technically challenging part (at least for me) for last -- learning how to create responsive webpages (where content adjusts size and positioning based on viewport size) involved a lot of trial and error.
...
While Julie, Stef, and I all had some level of experience using Quarto, we were dancing at the edge of our collective existing knowledge and trying out things that we weren't always sure would work out. Sharing progress and celebrating victories was a super important part of the process.
...
knitr::include_graphics("live-troubleshooting.png")
```
...
knitr::include_graphics("slack.png")
```
...
#### **Greatest victory:** responsive webpages

A *responsive* web page is one with elements that automatically resize and reorganize based on the size and shape of the viewport and/or device it's being viewed on. This responsiveness is critically important for ensuring a high quality user experience, regardless how a user is accessing a website.

For example, note how elements organized in columns (e.g. Engage/Empower/Amplify, the three stat boxes) when the browser viewport is at full width will stack vertically once the browser window is made narrower:
...
#| out-width: "80%" 
#| fig-alt: ""
knitr::include_graphics("laptop.gif")
```
...
#| out-width: "40%" 
#| fig-alt: ""
knitr::include_graphics("non-responsive.png")
```

Now note the automatic vertical stacking of elements when viewed from a mobile device:
...
#| out-width: "30%" 
#| fig-alt: ""
knitr::include_graphics("phone.gif")
```
...
#| fig-align: center
#| out-width: "85%" 
#| fig-alt: "The Openscapes website's landing page, as viewed on a mobile device. To the right is the \"Inspect\" window, which shows the webpage's underlying HTML and CSS. A button with a laptop and phone icon at the top of this section is circled in red. Clicking this button toggles between mobile and standard computer viewport sizes."

knitr::include_graphics("mobile-view.png")
```
...
I'm in this funny position where I'm a data science educator, but not a practicing data scientist. I teach learners to code, to troubleshoot, to communicate and collaborate, and help them develop the professional skills needed for the workforce...yet I really have so little professional experience myself.

I've struggled with Imposter's Syndrome throughout my professional career (as many do!), which began in grad school and has followed me ever since. I've worked really hard on learning to recognize my successes (self affirmations are important!!) and being less harsh on myself when I stumble. 


- freelancing/contracting typically involves hiring someone who knows *a lot* about completing a given task. I didn't quite fall into that category. Julie & Stef were encouraging, supportive, while also being transparent about what they wanted to see -- this pushed me to figure out things I would have otherwise dropped
<!-- - I've struggled with imposter's syndrome throughout my professional career, starting in grad school and following me ever since. I'm in this funny place where I teach new learners about data science tools, best practices, and how to collaborate on projects, yet I really have so little professional experience myself. Which only  -->

<!-- I'm in this funny situation where I teach new learners about data science best practices, collaborative  -->
