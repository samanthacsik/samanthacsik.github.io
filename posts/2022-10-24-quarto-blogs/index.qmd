...
About a year ago, I wrote my first ever blog post \~ about blogging \~ and tbh I'm a *little* embarrassed that this is only my third post here (does it count that I have *ideas* for blog posts squirreled away at least?? `r fontawesome::fa("grin-beam-sweat", fill = "#64605f", a11y = "sem")`). Regardless, you should trust me[^1] when I say that blogging is a great exercise for you to practice as regularly as you can -- it can help you learn a new skill, expand your professional portfolio/online profile, connect with others in your field, and more. Rather than repeat content here, take a peek at my [first post](https://samanthacsik.github.io/posts/2021-09-21-distill-blogs/), which touches on why you should blog and some ideas on how to structure your blog posts. And if you take just one thing away from all this, it's this tweet:
...
#| eval: true
#| echo: false
#| fig-cap: "The [MEDS Community Blog](https://ucsb-meds.github.io/blog.html) listing page, with multiple blog posts arranged in the default-style layout -- Quarto has multiple listing page layout options (default, grid, table) for you to explore"
...
You aren't limited to just one blog/listing page! Repeat [Part III](https://samanthacsik.github.io/posts/2022-10-24-quarto-blogs/#iii.-adding-a-blog-to-your-personal-quarto-website) to add a second listing page + content to your website. My personal website contains two blogs -- one called [posts](https://samanthacsik.github.io/posts.html) and another called [talks & workshops](https://samanthacsik.github.io/talks_workshops.html). Explore the [GitHub repo](https://github.com/samanthacsik/samanthacsik.github.io) to take a peek at the file structure and source code.
...
*Also note: I've added citations for each of these blog posts. Check out the [source code](https://github.com/samanthacsik/samanthacsik.github.io/blob/main/posts/2022-10-24-quarto-blogs/index.qmd) if you're looking for additional examples on how to do it.*
...
-   [Meghan Hall's Blog](https://meghan.rbind.io/blog/) -- find her on `r fontawesome::fa("twitter", fill = "#64605f", a11y = "sem")` [`@MeghanMHall`](https://twitter.com/MeghanMHall) and check out her post, [Increasing the Flexibility and Robustness of Plots in ggplot2](https://meghan.rbind.io/blog/plot-robustness/) [-@hall2022]
...
-   [Beatriz Milz's Blog](https://beamilz.com/posts/) -- find her on `r fontawesome::fa("twitter", fill = "#64605f", a11y = "sem")` [`@BeaMilz`](https://twitter.com/BeaMilz) and check out her post, [Introduction to GitHub Actions for R users](https://beamilz.com/posts/series-gha/2022-series-gha-1-what-is/en/) [-@milz2022]
