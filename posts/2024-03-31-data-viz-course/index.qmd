...
3. [Determine how to build & organizing course materials](#course-materials)
4. [Create assignments & figure out how best to distribute them](#assignments)
...
<!-- Implementing specifications (specs) grading{#grades} -->
...
While I did spend a lot of time providing detailed constructive feedback on assignments, I certainly saved myself time trying to assign / subtract points across assignments. Ultimately, concentrating my efforts on providing constructive criticisms was *a lot* more fun for me and (I hope) much more helpful for students in their learning journeys.
:::
...
My teaching assistant (TA), [Sevan Esaian](https://www.linkedin.com/in/sevan-esaian-92b7794b/) (who was absolutely incredible to work with), would lead these.
