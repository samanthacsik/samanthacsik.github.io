...
My extremely broad TODO list looked like this:

1. [Figure out my preparation timeline](#timeline)
2. [Build the course syllabus (incl. learning objectives, topics, schedule, policies)](#syllabus)
3. [Decide how I will assess student success (i.e. grades)](#grades)
4. [Determine how to build / organizing course materials](#course-materials)
5. [Create assignments and figure out how best to distribute them](#assignments)

I'll walk through each of these TODOs in a bit more detail, then end with some things that worked particularly well, things I'd like to do differently, and other musings.
...
- **January - March 2023:** Here we go! By this point, I had weeks 1-4 fully planned, weeks 5-6 outlined(ish), and weeks 7-10 were largely untouched (aside from having scheduled [Allison Horst](https://github.com/allisonhorst/)'s guest lecture on using Observable JS to create interactive viz during week 9!). I tried my best to work ahead and continue prepping future lectures / assignments / etc. but this wasn't totally sustainable. By ~week 5, I was prepping each lecture the week before delivering it. That said, I had compiled so many resources and jotted down so many random ideas as I came across things, that creating new lectures did get a bit easier as time went on.

## Building the course syllabus{#syllabus}
...
After a lot of iterating, seeking feedback from a mix of past MEDS students (now NCEAS data scientists) and other NCEAS educators, I ended up with a list of six learning objectives (check out the [syllabus](https://docs.google.com/document/d/1iv-bsakUA-7FDSZCt0Qq1TUYXBzq0cktzLlxV2AxhZc/edit#heading=h.thw5uolxraye) to see what they are!). **Next, I began mapping out tentative topics by date**, being mindful of holidays, large non-EDS 240 deadlines (e.g. [MEDS Capstone](https://bren.ucsb.edu/masters-programs/master-environmental-data-science/meds-capstone-projects) faculty reviews), and the skills we'd need to cover ahead of distributing each new homework assignment. This schedule was a detailed draft at best -- topics were shifted around a bit (e.g. I couldn't always cover as much as I planned in a given class) or dropped entirely as the quarter went on -- but it was an important starting point / road map for me a to return to as I moved through the planning process.

**After these pieces were drafted up, I started filling in the remaining (large) gaps: course policies, grading structure, student resources, etc.** The syllabus was in a constant state of revision right up until the start of the course, but getting that first draft squared away felt like a *huge* accomplishment and it served as my North Star when I finally began creating course materials.

## Deciding to implement specifications (specs) grading{#grades}
...
<!-- ::: {.center-text} -->
<!-- **An overview of course assignments and the specs grading implementation that I used in EDS 240 is summarized in the Grade Tracker, below:**  -->
<!-- ::: -->
...
I would be lying if I said that I wasn't **incredibly nervous** to try this out. While all the literature I had explored got me super jazzed about the idea of specs grading, it *is* quite different than what our students are used to...and **change can feel disruptive**. I spent the first full hour of our (3 hour-long) first class laying out this grading structure, the accompanying token system, and expectations (and of course, answering many questions).

Benefits:
- know what your grade is at any given point in time
- if you don't care about the + or the A, you can decide how to spend your energy
- no haggling over points
- revise / resubmit (also spreads out grading)

Quotes from students.

## How do you distribute materials?{#course-materials}

- course website
- google slides vs. quarto slides

## How do you distribute assessments?{#assignments}
...
- hws take a long time to come up with! need to streamline these
...
- specs grading worked great for me (grad students, 31 MEDS 6 non-MEDS, 37 total)
